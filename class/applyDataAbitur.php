...
class applyDataAbitur{
	function applyAbiturForm(){
	...
	function applyInfoAbityr($id){
		...
		echo '<tr><td><select required name="spec"><option value="">'; echo $txt->getStringForm('namespec'); echo '</option>'; $obj->spec(); echo '</select> ';
		echo '<select name="priority" required>';
		echo '<option value="">- Приоритет -</option>';
		echo '<option value="1">1</option>';
		echo '<option value="2">2</option>';
		echo '<option value="3">3</option>';
		echo '</select>';
// прикладной и академический (начало)
//		echo '<label class="checkbox"><input type="checkbox" checked value="1" name="akad_bak">Академический бакалавриат</label>';
//		echo '<label class="checkbox"><input type="checkbox" value="1" name="prik_bak">Прикладной бакалавриат</label>';
// прикладной и академический (конец)
		...
		echo '<tr><td><select required name="ekzam"><option value="">'; echo $txt->getStringForm('ekzam'); echo '</option>'; $obj->ekzam(); echo '</select></td>';
